          ...
          <div className="animate-fade-in-left">
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-gray-900">Hexa Integra Mandiri</h2>
                  <p className="text-hexa-red font-semibold">Solusi Teknologi Terintegrasi</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                CV. Hexa Integra Mandiri adalah perusahaan teknologi yang berfokus pada pengembangan 
                solusi aplikasi terintegrasi untuk kebutuhan bisnis modern. Dengan pengalaman yang 
                solid dalam industri IT, kami berkomitmen memberikan solusi teknologi terdepan.
              </p>
              
              <div className="grid gap-6">
                <h3 className="text-xl font-semibold text-gray-900">Keahlian Utama Kami:</h3>
